...
import { DependenciesPanel } from './index';
import {
  MockPanelProvider,
  createMockContext,
  createMockActions,
...
import type { PackagesSliceData, PackageLayer } from './types';
...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <DependenciesPanel context={context} actions={actions} events={events} />
    );
  },
};
